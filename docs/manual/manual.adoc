...
Download `phm_v<version>.ipa` from the https://github.com/caseystijlaart/PlantHealthMonitoring/releases[GitHub Releases page]. Full sideloading instructions using Sideloady on Windows are included in link:ios-sideloading.adoc[ios-sideloading.adoc].

==== Android

Download `phm_v<version>.apk` from the https://github.com/caseystijlaart/PlantHealthMonitoring/releases[GitHub Releases page] and install it (allow installation from unknown sources when prompted).

==== Windows

. Download `phm_v<version>_win64.zip` (portable) or `phm_v<version>.msix` (installer) from the https://github.com/caseystijlaart/PlantHealthMonitoring/releases[GitHub Releases page].
